        ...
        <motion.div 
          ...
          >
            <motion.h2
              ...
              className="text-4xl font-bold bg-gradient-to-r from-cyan-400 via-teal-400 to-cyan-300 bg-clip-text text-transparent"
              style={{ 
            ...
            {[...Array(3)].map((_, i) => (
              <motion.div
                ...
                animate={{ 
                  y: [0, -15, 0],
                  scale: [1, 1.2, 1],
                  backgroundColor: ['#22d3ee', '#67e8f9', '#22d3ee']
                }}
                transition={{ 
                  duration: 1.2, 
                  repeat: Infinity, 
    ...
    return (
      <div className="min-h-screen bg-black text-white p-6">
        <div className="max-w-5xl mx-auto">
          ...
          >
            <motion.h1 
              className="text-4xl font-bold bg-gradient-to-r from-cyan-400 via-teal-400 to-cyan-300 bg-clip-text text-transparent mb-4" 
              style={{ 
                background: 'linear-gradient(45deg, #22d3ee, #2dd4bf, #67e8f9)',
                WebkitBackgroundClip: 'text',
                WebkitTextFillColor: 'transparent'
          ...
          <div className="grid gap-6 md:grid-cols-2">
            {reportSections.map((section, index) => (
              ...
              >
                <Card
                  className="bg-slate-800 border border-slate-600 hover:border-cyan-400/60 transition-all duration-300 cursor-pointer shadow-lg hover:shadow-xl hover:shadow-cyan-400/20 group"
                  onClick={() => toggleCard(section.id)}
                >
                  <div className="p-6">
                    <div className="flex items-center justify-between mb-4">
                      <motion.h3 
                        className="text-lg font-semibold text-cyan-400 group-hover:text-cyan-300 transition-colors" 
                        style={{ color: '#22d3ee' }}
          ...
          >
            <Card className="bg-slate-800 border border-slate-600 shadow-lg">
              <div className="p-6">
                <motion.h3 
                  className="text-xl font-semibold text-cyan-400 mb-4 flex items-center space-x-2" 
                  style={{ color: '#22d3ee' }}
                  initial={{ opacity: 0, x: -10 }}
                  animate={{ opacity: 1, x: 0 }}
                      ...
                      >
                        <div className={`max-w-[80%] rounded-lg p-3 ${
                          ...
                          <div className="flex items-center space-x-2 mb-2">
                            ...
                            }`} style={{ color: message.role === 'user' ? '#93c5fd' : '#22d3ee' }}>
          ...
          >
            ...
            >
              <Button
                onClick={onBack}
                className="bg-gradient-to-r from-cyan-500 to-teal-500 hover:from-cyan-600 hover:to-teal-600 text-white font-semibold px-8 py-3 rounded-lg shadow-lg hover:shadow-xl transition-all duration-300 shadow-cyan-500/30"
                style={{ 
      ...
      <div className="container mx-auto px-4 py-6">
        ...
        >
          <div className="flex items-center space-x-4">
            ...
            <div className="flex items-center space-x-2">
              <Swords className="w-5 h-5 text-cyan-400" style={{ color: '#22d3ee' }} />
              <Badge className="bg-cyan-500/20 text-cyan-300 border border-cyan-400/50 font-semibold" style={{ backgroundColor: 'rgba(6, 182, 212, 0.2)', color: '#67e8f9', borderColor: 'rgba(34, 211, 238, 0.5)' }}>
                {roomName}
              </Badge>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
          ...
          <div className="lg:col-span-3">
            <Card className="bg-slate-900/50 border-2 border-cyan-500/30 backdrop-blur-sm shadow-2xl shadow-cyan-500/20 min-h-[75vh] flex flex-col" style={{ backgroundColor: 'rgba(15, 23, 42, 0.5)', borderColor: 'rgba(6, 182, 212, 0.3)' }}>
              {/* Messages Area */}
              <div ref={scrollContainer} className="flex-1 overflow-y-auto p-6 space-y-4 max-h-[65vh]">
                {messages.length === 0 && !isLoading ? (
                  <div className="text-center text-white/60 py-12">
                    <div className="w-16 h-16 bg-cyan-500/20 rounded-full flex items-center justify-center mx-auto mb-4" style={{ backgroundColor: 'rgba(6, 182, 212, 0.2)' }}>
                      <MessageCircle className="w-8 h-8 text-cyan-400" style={{ color: '#22d3ee' }} />
                    </div>
                      ...
                      >
                        <div className="flex items-center space-x-2 mb-3">
                          <motion.div 
                            ...
                            style={{ backgroundColor: message.role === 'user' ? 'rgba(59, 130, 246, 0.2)' : 'rgba(6, 182, 212, 0.2)', color: message.role === 'user' ? '#60a5fa' : '#22d3ee' }}
              ...
              <div className="border-t border-gray-700/50 p-4 bg-gray-900/30">
                ...
                <div className="flex space-x-3">
                  <textarea
                    ...
                    className={`flex-1 border rounded-xl transition-all resize-none min-h-[44px] max-h-[200px] py-3 px-4 ${
                      isOvertime 
                        ...
                        : 'bg-slate-800/50 border-slate-600/50 text-white placeholder-slate-400 focus:ring-2 focus:ring-cyan-400 focus:border-cyan-400'
                    }`}
                    style={{ 
                      backgroundColor: isOvertime ? 'rgba(127, 29, 29, 0.2)' : 'rgba(30, 41, 59, 0.5)', 
                      borderColor: isOvertime ? 'rgba(185, 28, 28, 0.5)' : 'rgba(71, 85, 105, 0.5)',
                      height: 'auto',
                      overflowY: 'auto'
                    }}
                    rows={1}
                  ...
                  <Button
                    ...
                    style={{ 
                      backgroundColor: isOvertime ? '#dc2626' : undefined,
                      background: isOvertime ? '#dc2626' : 'linear-gradient(90deg, #06b6d4, #14b8a6)',
                      color: '#ffffff',
                      borderColor: isOvertime ? '#dc2626' : undefined
                    }}
                  >
          ...
          <motion.div 
              ...
              >
                <Card className="p-4 bg-slate-800/20 border-2 border-cyan-500/30 backdrop-blur-sm shadow-lg shadow-cyan-500/10" style={{ backgroundColor: 'rgba(30, 41, 59, 0.2)', borderColor: 'rgba(6, 182, 212, 0.3)' }}>
                  <div className="flex items-center space-x-2 mb-3">
                    <Trophy className="w-5 h-5 text-cyan-400" style={{ color: '#22d3ee' }} />
